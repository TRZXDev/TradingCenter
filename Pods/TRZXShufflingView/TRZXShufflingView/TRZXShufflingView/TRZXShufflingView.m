...
@interface TRZXShufflingView () <UICollectionViewDelegate, UICollectionViewDataSource>
...
@implementation TRZXShufflingView

static NSString *CollectionCellID = @"TRZXShufflingCell";
...
//        [self.collectionView registerClass:[TRZXShufflingCell class] forCellWithReuseIdentifier:CollectionCellID];       // 注册 cell 重用
...
//    TRZXShufflingCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:CollectionCellID forIndexPath:indexPath];
    TRZXShufflingCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:CollectionCellID forIndexPath:indexPath];
...
- (void)images:(NSArray *)images {
    ...
    CGSize pointSize = [self.pageControl sizeForNumberOfPages:_imageCount];
